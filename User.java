 ...
 *  a list of user names that s/he follows, and the list's size. */
 public class User {
    ...
    public boolean addFollowee(String name) {
        if (follows(name)) {
            return false; //already follows said name
        }
         if (fCount == maxfCount) {
     ...
     *  If the name is not in the list, does nothing and returns false. In that
case we move all the array elements below this name one position “up”. And, we must remember
doing fCount--.*/
